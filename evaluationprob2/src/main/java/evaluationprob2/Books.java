...
public class Books {
	...
	public Books(int bookId, String name, String author, String publication, String category, int pages, int price,
	...
	public String toString() {
		return "Books [BookId=" + BookId + ", name=" + name + ", author=" + author + ", publication=" + publication
